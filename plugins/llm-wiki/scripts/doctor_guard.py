...
per-call hook (per the Phase 3 plan). Only a full-content **Write** is validated — Edit /
MultiEdit don't carry the whole resulting file, and the pre-existing file already passed.
